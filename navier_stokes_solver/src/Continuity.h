...
class continuity_finite_element_0: public ufc::finite_element
{
public:

  continuity_finite_element_0();

  ~continuity_finite_element_0() override;
...
class continuity_finite_element_1: public ufc::finite_element
{
public:

  continuity_finite_element_1();

  ~continuity_finite_element_1() override;
...
class continuity_finite_element_2: public ufc::finite_element
{
public:

  continuity_finite_element_2();

  ~continuity_finite_element_2() override;
...
class continuity_dofmap_0: public ufc::dofmap
{
public:

  continuity_dofmap_0();

  ~continuity_dofmap_0() override;
...
class continuity_dofmap_1: public ufc::dofmap
{
public:

  continuity_dofmap_1();

  ~continuity_dofmap_1() override;
...
class continuity_dofmap_2: public ufc::dofmap
{
public:

  continuity_dofmap_2();

  ~continuity_dofmap_2() override;
...
class continuity_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  continuity_cell_integral_0_otherwise();

  ~continuity_cell_integral_0_otherwise() override;
...
class continuity_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  continuity_cell_integral_1_otherwise();

  ~continuity_cell_integral_1_otherwise() override;
...
class continuity_form_0: public ufc::form
{
public:

  continuity_form_0();

  ~continuity_form_0() override;
...
class continuity_form_1: public ufc::form
{
public:

  continuity_form_1();

  ~continuity_form_1() override;
...
public:
  ...
  CoefficientSpace_k(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<continuity_finite_element_2>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<continuity_dofmap_2>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_k(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<continuity_finite_element_2>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<continuity_dofmap_2>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
  ...
  CoefficientSpace_u(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<continuity_finite_element_1>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<continuity_dofmap_1>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_u(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<continuity_finite_element_1>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<continuity_dofmap_1>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<continuity_finite_element_0>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<continuity_dofmap_0>(), *mesh))
  {
    // Do nothing
  }
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<continuity_finite_element_0>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<continuity_dofmap_0>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = std::make_shared<const continuity_form_0>();
  }
...
public:
  ...
  Form_L(std::shared_ptr<const dolfin::FunctionSpace> V0):
    dolfin::Form(1, 2), k(*this, 0), u(*this, 1)
  {
    _function_spaces[0] = V0;

    _ufc_form = std::make_shared<const continuity_form_1>();
  }

  // Constructor
  Form_L(std::shared_ptr<const dolfin::FunctionSpace> V0, std::shared_ptr<const dolfin::GenericFunction> k, std::shared_ptr<const dolfin::GenericFunction> u):
    dolfin::Form(1, 2), k(*this, 0), u(*this, 1)
  {
    _function_spaces[0] = V0;
...
public:
  ...
  MultiMeshForm_L(std::shared_ptr<const dolfin::MultiMeshFunctionSpace> V0):
    dolfin::MultiMeshForm(V0), k(*this, 0), u(*this, 1)
  {
    // Create and add standard forms
    std::size_t num_parts = V0->num_parts(); // assume all equal and pick first
    for (std::size_t part = 0; part < num_parts; part++)
  ...
  // Constructor
  MultiMeshForm_L(std::shared_ptr<const dolfin::MultiMeshFunctionSpace> V0, std::shared_ptr<const dolfin::GenericFunction> k, std::shared_ptr<const dolfin::GenericFunction> u):
    dolfin::MultiMeshForm(V0), k(*this, 0), u(*this, 1)
  {
    // Create and add standard forms
    std::size_t num_parts = V0->num_parts(); // assume all equal and pick first
