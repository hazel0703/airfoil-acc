...
class momentum_finite_element_0: public ufc::finite_element
{
public:

  momentum_finite_element_0();

  ~momentum_finite_element_0() override;
...
class momentum_finite_element_1: public ufc::finite_element
{
public:

  momentum_finite_element_1();

  ~momentum_finite_element_1() override;
...
class momentum_finite_element_2: public ufc::finite_element
{
public:

  momentum_finite_element_2();

  ~momentum_finite_element_2() override;
...
class momentum_finite_element_3: public ufc::finite_element
{
public:

  momentum_finite_element_3();

  ~momentum_finite_element_3() override;
...
class momentum_dofmap_0: public ufc::dofmap
{
public:

  momentum_dofmap_0();

  ~momentum_dofmap_0() override;
...
class momentum_dofmap_1: public ufc::dofmap
{
public:

  momentum_dofmap_1();

  ~momentum_dofmap_1() override;
...
class momentum_dofmap_2: public ufc::dofmap
{
public:

  momentum_dofmap_2();

  ~momentum_dofmap_2() override;
...
class momentum_dofmap_3: public ufc::dofmap
{
public:

  momentum_dofmap_3();

  ~momentum_dofmap_3() override;
...
class momentum_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  momentum_cell_integral_0_otherwise();

  ~momentum_cell_integral_0_otherwise() override;
...
class momentum_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  momentum_cell_integral_1_otherwise();

  ~momentum_cell_integral_1_otherwise() override;
...
class momentum_form_0: public ufc::form
{
public:

  momentum_form_0();

  ~momentum_form_0() override;
...
class momentum_form_1: public ufc::form
{
public:

  momentum_form_1();

  ~momentum_form_1() override;
...
public:
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<momentum_finite_element_1>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<momentum_dofmap_1>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<momentum_finite_element_1>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<momentum_dofmap_1>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
  ...
  CoefficientSpace_k(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<momentum_finite_element_2>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<momentum_dofmap_2>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_k(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<momentum_finite_element_2>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<momentum_dofmap_2>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
  ...
  CoefficientSpace_mu(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<momentum_finite_element_3>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<momentum_dofmap_3>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_mu(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<momentum_finite_element_3>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<momentum_dofmap_3>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
  ...
  CoefficientSpace_p(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<momentum_finite_element_0>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<momentum_dofmap_0>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_p(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<momentum_finite_element_0>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<momentum_dofmap_0>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
typedef CoefficientSpace_u0 Form_a_FunctionSpace_3;

typedef CoefficientSpace_nu Form_a_FunctionSpace_4;
...
public:
  ...
  Form_a(std::shared_ptr<const dolfin::FunctionSpace> V1, std::shared_ptr<const dolfin::FunctionSpace> V0):
    dolfin::Form(2, 4), k(*this, 0), u0(*this, 1), nu(*this, 2), mu(*this, 3)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;

    _ufc_form = std::make_shared<const momentum_form_0>();
  }

  // Constructor
  Form_a(std::shared_ptr<const dolfin::FunctionSpace> V1, std::shared_ptr<const dolfin::FunctionSpace> V0, std::shared_ptr<const dolfin::GenericFunction> k, std::shared_ptr<const dolfin::GenericFunction> u0, std::shared_ptr<const dolfin::GenericFunction> nu, std::shared_ptr<const dolfin::GenericFunction> mu):
    dolfin::Form(2, 4), k(*this, 0), u0(*this, 1), nu(*this, 2), mu(*this, 3)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;
  ...
  typedef Form_a_FunctionSpace_3 CoefficientSpace_u0;
  typedef Form_a_FunctionSpace_4 CoefficientSpace_nu;
...
public:
  ...
  MultiMeshForm_a(std::shared_ptr<const dolfin::MultiMeshFunctionSpace> V1, std::shared_ptr<const dolfin::MultiMeshFunctionSpace> V0):
    dolfin::MultiMeshForm(V1, V0), k(*this, 0), u0(*this, 1), nu(*this, 2), mu(*this, 3)
  {
...
typedef CoefficientSpace_nu Form_L_FunctionSpace_5;

typedef CoefficientSpace_mu Form_L_FunctionSpace_6;
...
public:
  ...
  Form_L(std::shared_ptr<const dolfin::FunctionSpace> V0):
    dolfin::Form(1, 6), k(*this, 0), u0(*this, 1), p(*this, 2), f(*this, 3), nu(*this, 4), mu(*this, 5)
  {
    _function_spaces[0] = V0;

    _ufc_form = std::make_shared<const momentum_form_1>();
  }
  ...
  typedef Form_L_FunctionSpace_5 CoefficientSpace_nu;
  typedef Form_L_FunctionSpace_6 CoefficientSpace_mu;
...
public:
  ...
  MultiMeshForm_L(std::shared_ptr<const dolfin::MultiMeshFunctionSpace> V0):
    dolfin::MultiMeshForm(V0), k(*this, 0), u0(*this, 1), p(*this, 2), f(*this, 3), nu(*this, 4), mu(*this, 5)
  {
    // Create and add standard forms
    std::size_t num_parts = V0->num_parts(); // assume all equal and pick first
    for (std::size_t part = 0; part < num_parts; part++)
